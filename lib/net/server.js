 ...
 * The Server Class
 *
 * This class is used to provide an easy way to listen
 * out for incoming client connections on a given port
 * and host. It will automatically manage client capacity
 * and handles socket transport designation.
 *
