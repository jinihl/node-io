...
exports.websocket76 = websocket75.extend({
    ...
    handshake: function(request) {
        ...
        [key1, key2].forEach(function(key) {
            ...
            // Get the digits, number of spaces
            var digits = parseInt(key.replace(/[^\d]/g, "")),
             ...
             if (spaces === 0 || digits % spaces !== 0) {
                ...
                // Does not meet the websocket handshake requirements
                return false;
             }
             ...
             // Pack the key into a 32-bit large-endian format and add it to the hash
